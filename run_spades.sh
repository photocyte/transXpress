...
/lab/solexa_weng/testtube/nextflow/nextflow-19.02.0-edge-all run spadesXpress.nf -profile test_nonSS -resume 1>>transXpress.stdout.log 2>transXpress.stderr.log &
disown
